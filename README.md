...
```bash
# 1. Runtime: the pinned build + SHA-pinned model. Current image tag + sha: gittensor.io/compute ("Current
#    release" card has the copy-paste command); images live at hub.docker.com/u/entrius
