...
Blessing is curation (vault 25): qualify on our own 5090 first (the full end-to-end run), then dispatch the
workflow with the manifest path, the image digest and the qualification JSON. A changed image or manifest under the
