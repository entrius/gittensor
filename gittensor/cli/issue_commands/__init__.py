...
issue.add_command(issue_deposit, name='deposit')
issue.add_command(issue_prefer, name='prefer')
issue.add_command(issue_enroll, name='enroll')
issue.add_command(issue_withdraw, name='withdraw')
