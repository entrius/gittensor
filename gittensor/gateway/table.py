...
class InstanceTable:
    ...
    def model_objects(self) -> list[dict[str, Any]]:
        ...
        the runtime's own advertised value, else omitted (the gateway invents and clamps no cap of its own, Kimbo
        ...
        for name, entry_id in sorted(by_name.items()):
            ...
            if cap:
                obj['max_output_tokens'] = cap  # the manifest wins; else the runtime's own number stands, or none
