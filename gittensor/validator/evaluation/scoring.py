...
def score_pull_requests(
    ...
    for n, pr in enumerate(miner_eval.pull_requests, start=1):
        ...
        # Track repository contribution BEFORE checking file changes to prevent KeyError
        # in apply_cross_miner_multipliers_and_finalize when calculating uniqueness
