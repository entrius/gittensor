...
async def get_rewards(
    ...
    Returns:
        Tuple of (raw_score_array, miner_evaluations, cached_uids, penalized_uids).
        DB storage and emission allocation are handled by the caller (forward.py).
    """
    ...
    return (
        np.array([miner_evaluations[uid].total_score for uid in sorted(uids)]),
        miner_evaluations,
        cached_uids,
        penalized_uids,
    )
