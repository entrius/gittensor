...
def is_token_typo(old: str, new: str, max_dist=TYPO_MAX_DIST, min_sim=TYPO_MIN_SIM) -> bool:
    ...
    return all(token_pair_typo(o, n, max_dist, min_sim) for o, n in zip(old_tokens, new_tokens))
...
def count_non_scoreable_lines(
    patch: str, max_scoreable_lines: Optional[int] = None, file_extension: Optional[str] = None
) -> int:
