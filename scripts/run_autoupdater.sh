...
echo "  pm2 logs gittensor-autoupdater    # View logs"
echo "  pm2 stop gittensor-autoupdater    # Stop auto-updater"
echo "  pm2 restart gittensor-autoupdater # Restart auto-updater"
echo "  pm2 delete gittensor-autoupdater  # Remove auto-updater"
