...
def test_repo_matching_is_case_insensitive_for_pr_scores():
    repos = {'repo/a': RepositoryConfig(emission_share=0.2, issue_discovery_share=0.0)}
    evaluations = {
        0: _eval(0),
        1: _eval(1, [('Repo/A', 10.0)]),
...
def test_repo_matching_is_case_insensitive_for_issue_scores():
    repos = {'repo/a': RepositoryConfig(emission_share=0.2, issue_discovery_share=1.0)}
    evaluations = {
        0: _eval(0),
        1: _eval(1, issue_scores=[('Repo/A', 10.0)]),
    }
...
def test_issue_discovery_share_one_disables_pr_rewards_and_recycles_empty_issue_side():
    repos = {'repo/a': RepositoryConfig(emission_share=0.2, issue_discovery_share=1.0)}
    evaluations = {
        1: _eval(1, [('repo/a', 10.0)]),
        0: _eval(0),
