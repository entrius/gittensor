...
class TestCalculateReviewQualityMultiplier:
    ...
    def test_table_values(self):
        """Verify the lookup table from the issue spec."""
        expected = {
            0: 1.00,
            1: 0.88,
            2: 0.76,
    ...
    def test_floor_at_zero(self):
        ...
        # 9 reviews → 1.0 - 0.12*9 = -0.08, should be clamped to 0.0
...
class TestReviewQualityMultiplierOnPullRequest:
    ...
    def test_review_multiplier_reduces_earned_score(self, builder, bronze):
        ...
        # One CHANGES_REQUESTED review → 12% penalty
    ...
    def test_multiplier_included_in_calculate_final_earned_score(self, builder, bronze):
